...
Canonical product facts for Publish Everywhere. Use this before changing product behavior, UX copy, platform promises, onboarding, analytics language, or workflow assumptions.
...
- Publish Everywhere is an AI-powered content distribution app built on Postiz.
...
- The public app URL is `https://publisheverywhere.halowebsites.com`.
...
- Scheduling is currently Publish Everywhere/Temporal local scheduling, not native scheduled-post visibility inside platforms unless verified against platform docs.
