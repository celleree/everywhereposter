...
-- CreateEnum
CREATE TYPE "KnowledgeSourceType" AS ENUM ('TRANSCRIPT');

-- CreateEnum
CREATE TYPE "KnowledgeInputMethod" AS ENUM ('PASTE', 'UPLOAD');
...
-- CreateEnum
CREATE TYPE "State" AS ENUM ('QUEUE', 'PUBLISHED', 'DELETED_REMOTE', 'ERROR', 'DRAFT');
...
CREATE TABLE "KnowledgeDocument" (
    ...
    "title" TEXT NOT NULL,
    "sourceType" "KnowledgeSourceType" NOT NULL DEFAULT 'TRANSCRIPT',
    "inputMethod" "KnowledgeInputMethod" NOT NULL,
...
CREATE TABLE "VoiceProfile" (
    ...
    "lineBreakHabit" TEXT NOT NULL,
    "ctaStyle" TEXT NOT NULL,
    "vocabularyTendencies" JSONB,
    "tabooPhrases" JSONB,
    "preferredOpenings" JSONB,
    "approvedFactsJson" JSONB,
...
-- CreateTable
CREATE TABLE "IntegrationAnalyticsSnapshot" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    ...
    CONSTRAINT "IntegrationAnalyticsSnapshot_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "HistoricalImportSource" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "ownerUserId" TEXT,
    ...
    "initialBackfillCompletedAt" TIMESTAMP(3),
    "syncCursor" JSONB,
    "oldestImportedPublishedAt" TIMESTAMP(3),
    "newestImportedPublishedAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "HistoricalImportSource_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "HistoricalImportJob" (
    "id" TEXT NOT NULL,
    ...
    "postsSeenCount" INTEGER NOT NULL DEFAULT 0,
    "postsCreatedCount" INTEGER NOT NULL DEFAULT 0,
    "postsUpdatedCount" INTEGER NOT NULL DEFAULT 0,
    "postsSkippedCount" INTEGER NOT NULL DEFAULT 0,
    "metricsUpdatedCount" INTEGER NOT NULL DEFAULT 0,
    "errorCode" TEXT,
    "errorMessage" TEXT,
    ...
    CONSTRAINT "HistoricalImportJob_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "HistoricalPost" (
    ...
    "deletedOrUnavailableAt" TIMESTAMP(3),
    "visibility" TEXT NOT NULL DEFAULT 'unknown',
    "language" TEXT,
    "isHistoricalImport" BOOLEAN NOT NULL DEFAULT true,
    "readOnly" BOOLEAN NOT NULL DEFAULT true,
    "rawPlatformData" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "HistoricalPostMetric" (
    "id" TEXT NOT NULL,
    "historicalPostId" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "platform" TEXT NOT NULL,
    "metricName" TEXT NOT NULL,
    ...
    CONSTRAINT "HistoricalPostMetric_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "KnowledgeDocument_createdByUserId_idx" ON "KnowledgeDocument"("createdByUserId");
...
-- CreateIndex
CREATE INDEX "VoiceProfile_organizationId_isActive_idx" ON "VoiceProfile"("organizationId", "isActive");

-- CreateIndex
CREATE UNIQUE INDEX "VoiceProfile_organizationId_version_key" ON "VoiceProfile"("organizationId", "version");
...
-- CreateIndex
CREATE INDEX "IntegrationAnalyticsSnapshot_organizationId_integrationId_r_idx" ON "IntegrationAnalyticsSnapshot"("organizationId", "integrationId", "rangeDays", "snapshotDate");

-- CreateIndex
CREATE INDEX "IntegrationAnalyticsSnapshot_integrationId_metricName_range_idx" ON "IntegrationAnalyticsSnapshot"("integrationId", "metricName", "rangeDays", "snapshotDate");

-- CreateIndex
CREATE UNIQUE INDEX "IntegrationAnalyticsSnapshot_organizationId_integrationId_m_key" ON "IntegrationAnalyticsSnapshot"("organizationId", "integrationId", "metricName", "rangeDays", "snapshotDate");
...
-- CreateIndex
CREATE INDEX "HistoricalImportSource_organizationId_idx" ON "HistoricalImportSource"("organizationId");

-- CreateIndex
CREATE INDEX "HistoricalImportSource_platform_idx" ON "HistoricalImportSource"("platform");

-- CreateIndex
CREATE INDEX "HistoricalImportSource_connectedAccountId_idx" ON "HistoricalImportSource"("connectedAccountId");

-- CreateIndex
CREATE INDEX "HistoricalImportSource_status_idx" ON "HistoricalImportSource"("status");

-- CreateIndex
CREATE INDEX "HistoricalImportSource_lastSuccessfulSyncAt_idx" ON "HistoricalImportSource"("lastSuccessfulSyncAt");

-- CreateIndex
CREATE UNIQUE INDEX "HistoricalImportSource_organizationId_platform_platformAcco_key" ON "HistoricalImportSource"("organizationId", "platform", "platformAccountId");

-- CreateIndex
CREATE INDEX "HistoricalImportJob_sourceId_createdAt_idx" ON "HistoricalImportJob"("sourceId", "createdAt");

-- CreateIndex
CREATE INDEX "HistoricalImportJob_organizationId_status_idx" ON "HistoricalImportJob"("organizationId", "status");

-- CreateIndex
CREATE INDEX "HistoricalImportJob_platform_status_idx" ON "HistoricalImportJob"("platform", "status");

-- CreateIndex
CREATE INDEX "HistoricalImportJob_jobType_idx" ON "HistoricalImportJob"("jobType");

-- CreateIndex
CREATE INDEX "HistoricalImportJob_createdAt_idx" ON "HistoricalImportJob"("createdAt");

-- CreateIndex
CREATE INDEX "HistoricalPost_organizationId_publishedAt_idx" ON "HistoricalPost"("organizationId", "publishedAt");

-- CreateIndex
CREATE INDEX "HistoricalPost_sourceId_publishedAt_idx" ON "HistoricalPost"("sourceId", "publishedAt");

-- CreateIndex
CREATE INDEX "HistoricalPost_platform_platformPostId_idx" ON "HistoricalPost"("platform", "platformPostId");

-- CreateIndex
CREATE INDEX "HistoricalPost_connectedAccountId_idx" ON "HistoricalPost"("connectedAccountId");

-- CreateIndex
CREATE INDEX "HistoricalPost_publishedAt_idx" ON "HistoricalPost"("publishedAt");

-- CreateIndex
CREATE UNIQUE INDEX "HistoricalPost_organizationId_platform_platformAccountId_pl_key" ON "HistoricalPost"("organizationId", "platform", "platformAccountId", "platformPostId");

-- CreateIndex
CREATE INDEX "HistoricalPostMetric_historicalPostId_metricName_observedAt_idx" ON "HistoricalPostMetric"("historicalPostId", "metricName", "observedAt");

-- CreateIndex
CREATE INDEX "HistoricalPostMetric_organizationId_platform_metricName_idx" ON "HistoricalPostMetric"("organizationId", "platform", "metricName");

-- CreateIndex
CREATE INDEX "HistoricalPostMetric_observedAt_idx" ON "HistoricalPostMetric"("observedAt");
...
-- AddForeignKey
ALTER TABLE "VoiceProfile" ADD CONSTRAINT "VoiceProfile_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "IntegrationAnalyticsSnapshot" ADD CONSTRAINT "IntegrationAnalyticsSnapshot_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "IntegrationAnalyticsSnapshot" ADD CONSTRAINT "IntegrationAnalyticsSnapshot_integrationId_fkey" FOREIGN KEY ("integrationId") REFERENCES "Integration"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HistoricalImportSource" ADD CONSTRAINT "HistoricalImportSource_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HistoricalImportJob" ADD CONSTRAINT "HistoricalImportJob_sourceId_fkey" FOREIGN KEY ("sourceId") REFERENCES "HistoricalImportSource"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HistoricalImportJob" ADD CONSTRAINT "HistoricalImportJob_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HistoricalPost" ADD CONSTRAINT "HistoricalPost_sourceId_fkey" FOREIGN KEY ("sourceId") REFERENCES "HistoricalImportSource"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HistoricalPostMetric" ADD CONSTRAINT "HistoricalPostMetric_historicalPostId_fkey" FOREIGN KEY ("historicalPostId") REFERENCES "HistoricalPost"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HistoricalPostMetric" ADD CONSTRAINT "HistoricalPostMetric_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
