        ...
        <div className="bg-newBgColorInner rounded-[12px] border border-newBorder overflow-hidden">
            ...
            <div>
              ...
              <div className="text-[13px] text-customColor18 mt-[2px]">
                {t(
                  ...
                  'Create an OAuth application to allow third-party integrations with EverywherePoster on behalf of your users.'
                )}
              </div>
            </div>
            <div className="flex gap-[6px] shrink-0 pt-[2px]">
              <a
                className="cursor-pointer px-[16px] h-[36px] bg-btnPrimary hover:opacity-90 text-white transition-opacity rounded-[8px] text-[13px] font-[600] flex items-center gap-[6px]"
          ...
          <div className="p-[20px]">
            <button
              ...
              className="cursor-pointer px-[20px] h-[44px] bg-btnPrimary hover:opacity-90 transition-opacity text-white rounded-[8px] text-[15px] font-[600]"
            >
