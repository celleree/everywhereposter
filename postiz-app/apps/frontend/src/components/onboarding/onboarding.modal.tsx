  ...
  return (
    <div className="flex flex-col gap-[24px]">
      ...
      <div className="flex justify-end pt-[24px] mt-[8px]">
        <button
          onClick={onNext}
          className="group flex items-center gap-[12px] bg-btnPrimary hover:opacity-90 text-white font-semibold px-[32px] py-[14px] rounded-[12px] text-[16px] transition-opacity"
        >
          {sortedIntegrations.length > 0
            ? t('continue', 'Continue')
